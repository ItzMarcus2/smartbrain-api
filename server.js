...
app.put('https://secret-crag-71418.herokuapp.com/image', (req, res) => {
  const { id } = req.body;
...
/*
 ...
 /signin --> POST (will respond one of the two) success or fail
 /register --> POST = returning the new user object
 /profile/:userId --> GET = (return the user) user
